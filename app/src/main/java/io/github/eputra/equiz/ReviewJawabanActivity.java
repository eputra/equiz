...
public class ReviewJawabanActivity extends AppCompatActivity {
    ...
    @BindView(R.id.svReviewJawaban) ScrollView svReviewJawaban;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_review_jawaban);
    ...
    public void onBackPressed() {
        if (nomor_soal == 1) {
            Intent i = new Intent(ReviewJawabanActivity.this, MahasiswaActivity.class);
            startActivity(i);
            finish();
        } else {
            nomor_soal -= 1;
            loadReviewJawaban();
            svReviewJawaban.fullScroll(ScrollView.FOCUS_UP);
    ...
    private void loadReviewJawaban() {
        ...
        call.enqueue(new Callback<ReviewJawaban>() {
                ...
                if (value.equals("1")) {
                    if (btnSelanjutnya.getText().toString().equalsIgnoreCase("Selesai")) {
                        ...
                        if (jawabahan_mahasiswa.equals("N")) {
                            tvJawabanMahasiswa.setText("Anda tidak mengerjakan soal ini.");
                        } else if (jawabahan_mahasiswa.equals(kunci_jawaban)) {
                            tvJawabanMahasiswa.setText("Benar : Jawaban Anda " + jawabahan_mahasiswa);
                        } else {
                            tvJawabanMahasiswa.setText("Salah : Jawaban Anda " + jawabahan_mahasiswa);
                        }
            ...
            public void onFailure(Call<ReviewJawaban> call, Throwable t) {
                Toast.makeText(ReviewJawabanActivity.this, "Jaringan Error!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
